...
<style>
    ...
    html:not(.dark) .konten-mahasiswa :where(h1,
        ...
        textarea,
        select,
        .fi-logo):not(.bg-yellow-400):not(.bg-emerald-400):not(.bg-yellow-400 *):not(.bg-emerald-400 *):not(.bg-emerald-500 *):not(.fi-link *):not(.w-max *) {
        font-size: <?php echo e($fontSize); ?> !important;
...
<?php /**PATH D:\MY PROJEK\HERD\CLIENT\pro2lms\resources\views/components/dynamic-mahasiswa-style.blade.php ENDPATH**/ ?>