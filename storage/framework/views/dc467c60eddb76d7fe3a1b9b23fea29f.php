...
<div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" style="display: <?php echo e($show ? 'block' : 'none'); ?>;"
    ...
    <div class="<?php echo e($maxWidth); ?> mb-6 transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:mx-auto sm:w-full"
...
<?php /**PATH D:\MY PROJEK\HERD\CLIENT\pro2lms\resources\views/components/popup.blade.php ENDPATH**/ ?>